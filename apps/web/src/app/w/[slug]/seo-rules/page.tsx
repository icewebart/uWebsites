...
// Split off "Voice & Rules" — this half is the rules every article must
// follow regardless of tone (structure, SEO mechanics, sourcing). The tone
// half (tagline, voice, examples) moved to its own Brand Voice tab.
